...
class BaseModel:
    ...
    def run(self, train_matrix, train_y, validation_matrix, validation_y, variable_name):
        ...
        history = self.model.fit(train_matrix, train_y, epochs=100, batch_size=128, verbose=1, validation_data = (validation_matrix, validation_y), shuffle=True,callbacks=[checkpointer])
